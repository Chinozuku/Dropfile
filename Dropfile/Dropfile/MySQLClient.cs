...
namespace Dropfile
{
    ...
    class MySQLClient
    {
        ...
        public Dictionary<string, string> Select(string table, string field, string WHERE)
        {
            ...
            if (this.Open())
            {
                ...
                try
                {
                    ...
                    while (dataReader.Read())
                    {
                        ...
                        {
                            if (a) selectResult.Add(dataReader.GetName(i), dataReader.GetValue(0).ToString());
                        }
                        a = false;
                    }
                    dataReader.Close();
